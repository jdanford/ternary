...
pub const TRYTE4_NEG4096: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_278, TRYTE_NEG6];
pub const TRYTE4_NEG512: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_217, TRYTE_NEG1];
pub const TRYTE4_NEG256: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_NEG256, TRYTE_0];
pub const TRYTE4_NEG81: [Tryte; 4] = [TRYTE_NEG81, TRYTE_0, TRYTE_0, TRYTE_0];
pub const TRYTE4_NEG64: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_NEG64, TRYTE_0];
pub const TRYTE4_NEG16: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_NEG16, TRYTE_0];
pub const TRYTE4_NEG9: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_NEG9, TRYTE_0];
pub const TRYTE4_NEG8: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_NEG8, TRYTE_0];
pub const TRYTE4_NEG1: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_NEG1, TRYTE_0];
pub const TRYTE4_0: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_0, TRYTE_0];
pub const TRYTE4_1: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_1, TRYTE_0];
pub const TRYTE4_8: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_8, TRYTE_0];
pub const TRYTE4_9: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_9, TRYTE_0];
pub const TRYTE4_16: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_16, TRYTE_0];
pub const TRYTE4_64: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_64, TRYTE_0];
pub const TRYTE4_81: [Tryte; 4] = [TRYTE_81, TRYTE_0, TRYTE_0, TRYTE_0];
pub const TRYTE4_256: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_256, TRYTE_0];
pub const TRYTE4_512: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_NEG217, TRYTE_1];
pub const TRYTE4_4096: [Tryte; 4] = [TRYTE_0, TRYTE_0, TRYTE_NEG278, TRYTE_6];
